package com.robustrade.newsboard.di

import android.content.Context
import androidx.room.Room
import com.robustrade.newsboard.NewsApiService
import com.robustrade.newsboard.data.local.BookmarkDao
import com.robustrade.newsboard.data.local.db.AppDatabase
import com.robustrade.newsboard.data.repository.NewsRepositoryImpl
...
// addMigrations(...) in production
    ...
    @Provides
    @Singleton
    fun provideNewsRepository(api: NewsApiService, dao: BookmarkDao):
